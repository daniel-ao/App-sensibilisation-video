// frontend/assets/js/Index/player.js
...
async function loadVideosFromServer() {
    try {
        ...
        const [adulteRes, enfantRes] = await Promise.all([
            ...
            fetch(`${API_BASE_URL}/api/get-videos?mode=adulte&includeLicensed=${includeLicensed}`),
            fetch(`${API_BASE_URL}/api/get-videos?mode=enfant`)
        ]);
