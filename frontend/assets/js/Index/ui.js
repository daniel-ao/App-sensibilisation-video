// frontend/assets/js/Index/ui.js
...
function openTab(index) {
    ...
    if (nextBtn) nextBtn.style.visibility = index === TABS.length - 1 ? "hidden" : "visible";
}
...
function initHeaderMenu() {
    ...
    document.addEventListener('click', (e) => {
        if (!popup.contains(e.target) && !menuButton.contains(e.target)) {
...
function initUI() {
    ...
    initPseudoHandling();
    initHeaderMenu(); // Initialize the new menu
