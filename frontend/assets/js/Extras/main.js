    ...
    expectedDevices.forEach(dev => {
      ...
      if (deviceHasData(dataForDev)) {
        ...
        try {
          ...
          // Remove the default enlarge button added by createChart (the "down" one)
          const defaultBtn = sub.querySelector('.chart-enlarge-btn-floating');
          ...
          if (chartWrapper && canvas) {
            ...
            function openChartModal() {
              ...
              try {
                ...
                // Remove the default enlarge button in the modal too
                const defaultBtnModal = body.querySelector('.chart-enlarge-btn-floating');
                if (defaultBtnModal) defaultBtnModal.remove();
